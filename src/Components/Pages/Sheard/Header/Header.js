...
const Header = () => {
  ...
  if(isLoading){
    ...
    return (
        <div>
            <Navbar className="bg-primary" variant="light"  collapseOnSelect expand="lg">
    <Container>
    ...
    <Nav className="me-auto d-flex justify-content-center align-items-center ">
      <Nav.Link style={{color:'#ffff',fontSize:'20px'}}   as={Link} to="/home">Home</Nav.Link>
      <Nav.Link style={{color:'#ffff',fontSize:'20px'}}  as={Link}to="/services">Services</Nav.Link>
      <Nav.Link style={{color:'#ffff',fontSize:'20px'}}  as={Link} to="/addservice">Add service</Nav.Link>
      <Nav.Link style={{color:'#ffff',fontSize:'20px'}}  as={Link} to="/myorder">My Order</Nav.Link>
      <Nav.Link style={{color:'#ffff',fontSize:'20px'}}  as={Link} to="/mannageorder">All Manage Order</Nav.Link>
      {
